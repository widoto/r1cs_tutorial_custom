...
use crate::gadgets::did::VroomLicenseScheme;

pub trait SigVerifyGadget<S: VroomLicenseScheme, ConstraintF: Field> {
...
pub trait SigRandomizePkGadget<S: VroomLicenseScheme, ConstraintF: Field> {
    type ParametersVar: AllocVar<S::Parameters, ConstraintF> + Clone;
